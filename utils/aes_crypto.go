...
// https://github.com/fastwego/offiaccount/blob/master/util/aes_crypto.go
...
func AESEncryptMsg(random, rawXMLMsg []byte, appId string, encodingAESKey string) (string, error) {
